...
{    
    ...
    throws Exception
    {
        ...
        PluginConcept administratorPlugin = new PluginConcept("org.lucane.applications.administrator", "0.7-beta");
        ...
        PluginConcept filemanagerPlugin = new PluginConcept("org.lucane.applications.filemanager", "0.7-beta");
        ...
        //forum application
        PluginConcept forumPlugin = new PluginConcept("org.lucane.applications.forum", "0.7-beta");
        ...
        PluginConcept forumadminPlugin = new PluginConcept("org.lucane.applications.forumadmin", "0.7-beta");
        ...
        PluginConcept helpbrowserPlugin = new PluginConcept("org.lucane.applications.helpbrowser", "0.7-beta");
        allUsers.addPlugin(helpbrowserPlugin);
        getPluginStore().storePlugin(helpbrowserPlugin);
                
        //maininterface application
        PluginConcept maininterfacePlugin = new PluginConcept("org.lucane.applications.maininterface", "0.7-beta");
		...
		PluginConcept quicklaunchPlugin = new PluginConcept("org.lucane.applications.quicklaunch", "0.7-beta");
		allUsers.addPlugin(quicklaunchPlugin);
		admins.addPlugin(quicklaunchPlugin);		
		getPluginStore().storePlugin(quicklaunchPlugin);
        
        //notes application
        PluginConcept notesPlugin = new PluginConcept("org.lucane.applications.notes", "0.7-beta");
        ...
        PluginConcept passwdchangerPlugin = new PluginConcept("org.lucane.applications.passwdchanger", "0.7-beta");
        ...
        PluginConcept pluginsinfosPlugin = new PluginConcept("org.lucane.applications.pluginsinfos", "0.7-beta");
        allUsers.addPlugin(pluginsinfosPlugin);
        getPluginStore().storePlugin(pluginsinfosPlugin);
       
        //quickmessage application
        PluginConcept quickmessagePlugin = new PluginConcept("org.lucane.applications.quickmessage", "0.7-beta");
		allUsers.addPlugin(quickmessagePlugin);
		admins.addPlugin(quickmessagePlugin);
        getPluginStore().storePlugin(quickmessagePlugin);
              
        //reunion application
        PluginConcept reunionPlugin = new PluginConcept("org.lucane.applications.reunion", "0.7-beta");
        allUsers.addPlugin(reunionPlugin);
        getPluginStore().storePlugin(reunionPlugin);
        
        //sendfile application
        PluginConcept sendfilePlugin = new PluginConcept("org.lucane.applications.sendfile", "0.7-beta");
        allUsers.addPlugin(sendfilePlugin);
        getPluginStore().storePlugin(sendfilePlugin);

		//audioconf application
		PluginConcept audioconfPlugin = new PluginConcept("org.lucane.applications.audioconf", "0.7-beta");
		allUsers.addPlugin(audioconfPlugin);
		getPluginStore().storePlugin(audioconfPlugin);

		//kick application
		PluginConcept kickPlugin = new PluginConcept("org.lucane.applications.kick", "0.7-beta");
		...
		PluginConcept sqlnavigatorPlugin = new PluginConcept("org.lucane.applications.sqlnavigator", "0.7-beta");
		...
		PluginConcept calendarPlugin = new PluginConcept("org.lucane.applications.calendar", "0.7-beta");
		...
		PluginConcept reminderPlugin = new PluginConcept("org.lucane.applications.reminder", "0.7-beta");
		...
		//jmail
		PluginConcept jmailPlugin = new PluginConcept("org.lucane.applications.jmail", "0.7-beta");
		...
		//jmail account
		PluginConcept jmailaccountPlugin = new PluginConcept("org.lucane.applications.jmailaccount", "0.7-beta");
		...
		//jmail admin
		PluginConcept jmailadminPlugin = new PluginConcept("org.lucane.applications.jmailadmin", "0.7-beta");
